...
export const translations = {
  de: {
    ...
    payText: 'Bitte zahlen Sie die gewünschten Artikel.',
    scanning: 'Scanne...',
    ...
    heroSubSmall: 'Bitte warten...',
    paySub: 'Akzeptierte Methoden: Maestro, MasterCard, Visa',
  ...
  en: {
    ...
    payText: 'Please pay for the selected items.',
    paySub: 'Accepted methods: Maestro, MasterCard, Visa',
    scanning: 'Scanning...',
  ...
  it: {
    ...
    payText: 'Si prega di pagare gli articoli selezionati.',
    paySub: 'Metodi accettati: Maestro, MasterCard, Visa',
    scanning: 'Scansione...',
  ...
  ru: {
    ...
    payText: 'Пожалуйста, оплатите выбранные товары.',
    paySub: 'Принимаемые способы оплаты: Maestro, MasterCard, Visa',
    ...
    heroSubSmall: 'Пожалуйста, подождите…',
